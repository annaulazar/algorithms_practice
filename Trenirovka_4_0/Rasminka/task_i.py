...
# является правильной. Если A — правильная, то последовательности (A), [A], {A} — правильные. Если A и B
...
for brace in s:
    if brace not in braces:
        ...
        if not brace_stack or brace_stack.pop() != braces[brace]:
            print('no')
            break
else:
    print(['yes', 'no'][bool(brace_stack)])
