...
# государственные выборы: на этих выборах каждый штат имеет определенное число голосов — число выборщиков
...
while True:
    try:
        line = input()
        kandidat, votes = line.split()
        votes = int(votes)
        d[kandidat] = d.get(kandidat, 0) + votes
    except (EOFError, ValueError):
        break
kandidats = sorted(d)
for kandidat in kandidats:
    print(kandidat, d[kandidat])
