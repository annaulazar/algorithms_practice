...
# одновременно как в первом списке, так и во втором. Примечание. Эту задачу на Питоне можно решить в одну строчку.
# Формат ввода
...
res = set(map(int, input().split())) & set(map(int, input().split()))
print(len(res))
